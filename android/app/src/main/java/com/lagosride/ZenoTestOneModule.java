...
public class ZenoTestOneModule extends ReactContextBaseJavaModule {

    ZenoTestOneModule(ReactApplicationContext context) {
        super(context);
    }

    @Override
    public String getName() {
        return "ZenoTestOneModule";
    }

    private static final String TAG = "ZenoTestOneModule";
